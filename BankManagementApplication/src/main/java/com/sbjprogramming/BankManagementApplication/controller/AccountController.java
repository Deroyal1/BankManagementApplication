package com.sbjprogramming.BankManagementApplication.controller;
...
import com.sbjprogramming.BankManagementApplication.service.AccountService;
...
public class AccountController {
	...
	public ResponseEntity<String> deleteAccount(@PathVariable Long accountNumber) {
		...
		return ResponseEntity.status(HttpStatus.OK).body("Account Number:" + accountNumber + " Closed Successfully" );
	}
}
